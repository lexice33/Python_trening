...
"""Замена значений пар/ удаление пары словаря"""
...
zoo_animals['Rockhopper Penguin'] = 'Test_zhi_est'
print(zoo_animals)
...
#Добавляем элемент со значениями словаря
inventory['pocket'] = ['seashell', 'strange berry', 'lint']
print(inventory)
#Сортируем значения элемента словаря
inventory['backpack'].sort()

print(inventory)
# Удаляем знаение в элементе словаря
inventory['backpack'].remove('dagger')
print(inventory)
# Изменяем значение в элементе словаря
